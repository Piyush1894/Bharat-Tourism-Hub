        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="UserIndex.jsp" class="logo"> <img style="border-radius: 9px" src="<%=udao.getImage()%>" width="50" height="70" alt="logo"> <span class="logoclass" style="text-transform: uppercase"><%= udao.getName()%> </span> </a>
                    <a href="UserIndex.jsp" class="logo logo-small"> <img src="#" alt="Logo" width="30" height="30"> </a>
                </div>
