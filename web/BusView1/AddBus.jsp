<%-- 
    Document   : AddBus
    Created on : Dec 1, 2023, 6:24:41 AM
    Author     : user
--%>
...
<html>
    ...
    <body onload="checkAll()">
        ...
        <div class="content-container" >
            ...
            <form action="../BusAddController" class="m-auto">
                <div class="d-inline-block p-3 mainformdiv text-center rounded-3" style="background-color: whitesmoke;">
                    <div style="width: 100%;" class="text-center"><h4 class="h2">Add Bus</h4></div>
                    <label class="text-start">Bus No</label><br>
                    <input type="text" name="busNo" id="" required><br>
                    <label class="text-start">Bus Name</label><br>
                    <input type="text" name="busName" id="" required><br>
                    <label class="text-start">From City</label><br>
                    <input type="text" name="FromCity" id="" required><br>
                    <label class="text-start">To City</label><br>
                    <input type="text" name="ToCity" id="" required><br>
                    <label class="text-start">Dispatch Time</label><br>
                    <input type="text" name="time" required><br>
                    <label class="text-start"> Arrival Time</label><br>
                    <input type="text" name="travelDuration" required><br>
                    <label class="text-start">Station Name</label><br>
                    <input type="text" name="stationName" required><br>
                    <label class="text-start">Ticket Price</label><br>
                    <input type="number" name="ticketPrice" required><br>
                    <label class="text-start">Description</label><br>
                    <textarea name="descraption" id="" cols="30" rows="2"></textarea><br>
                    <input style="color: white;background-color: rgb(112, 112, 255);" class="border-0 rounded-3" type="submit" >
                </div>
            </form>
