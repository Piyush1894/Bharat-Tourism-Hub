<%-- 
    Document   : Login
    Created on : 1 Dec, 2023, 2:21:53 PM
    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            .login{
                background: url('https://www.agrashivtourandtravels.com/wp-content/uploads/2020/08/india-tourism-710x350.jpg'), #000;
                background-position: center;
                background-size: cover;
                display: flex;
                justify-content: center;
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul
                                ...
                                <li><a href="Login.jsp" class="dropdown-item">Admin Login</a></li>
                            </ul>
                        </li>
            ...
            <div class="container">
                <div class="row row-cols-lg-3">
                    <div class="col-lg-4 text-center">
                        <h2 style="color: #fff;" class="py-4">Bharat Tourism Hub</h2>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="py-2 text-center">
                            <button class="btn btn-dark btn-outline-light">Subscribe</button>
                        </div>
