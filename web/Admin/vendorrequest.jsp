...
<html lang="en">
    ...
    <body>
        <%
          ...
          List<VendorDAO> lvdao=adto.request();
        %>
                                    ...
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <form action="..//VendorApruve">
                                                    <input type="hidden" name="id" value="<%= u.getId() %>">
                                                    <input type="hidden" name="emailto" value="<%= u.getEmail() %>">
                                                    <td><button class="btn btn-success">Apruve</button></td>
                                                    </form>
                                                </tr>
                                                <%
                                                    }
