<%-- 
    Document   : all-users
    Created on : 4 Dec, 2023, 11:30:17 AM
    ...
    <body>
        <%
           AdminDTO adto=new AdminDTO();
                                                  List<UserDAO> ludao=adto.allUser();
        %>
                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li> <a href="reviews.jsp"><i class="far fa-bell"></i> <span>Revierws</span></a> </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="profile.jsp" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="image/<%= u.getImage() %>" alt="User Image"></a>
